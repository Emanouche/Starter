...
# Handling changes
If you need to change things such as navbar for example, you will find all the reusable component througout the pages in the folder : `/src/js`.
Change the html here and modifiy the css in the good file in `/src/css`.
